      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Image.asset(
              _currentIndex == 0
                  ? 'assets/images/icons/property_cyan.png'
                  : 'assets/images/icons/property.png',
              width: 24,
              height: 24,
            ),
            label: 'Home',
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
              _currentIndex == 1
                  ? 'assets/images/icons/spyglass_cyan.png'
                  : 'assets/images/icons/spyglass.png',
              width: 24,
              height: 24,
            ),
            label: 'Search',
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
              _currentIndex == 2
                  ? 'assets/images/icons/bot_cyan.png'
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
              _currentIndex == 3
                  ? 'assets/images/icons/user_cyan.png'
